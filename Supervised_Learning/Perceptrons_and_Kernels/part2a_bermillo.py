...
def online_polynomial_kernelized_perceptron(train_data, test_data, kernel, max_iter=100, p=1):
...
if __name__ == '__main__':
    ...
    # Run training
    alpha, info = online_polynomial_kernelized_perceptron(train_data, test_data, polynomial_kernel, max_iter=100, p=1)

    # Report total runtime
    print('Online Algorithm Total Runtime: {:.2f}s'.format(np.sum(info['elapsed_times'])))